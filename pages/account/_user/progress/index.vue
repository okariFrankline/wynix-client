                ...
                <v-card flat hover class="mb-1 project" v-for="order in orders" :key="order.id" :class="transaction_class()">
                    <v-row class="px-3">
                        ...
                        <v-col cols="6" sm="4" md="4">
                            <!-- <div class="caption grey--text font-weight-bold" style="text-decoration: underline;">Assignee</div> -->
                            <nuxt-link :to=" `/practise/${order.owner_id}` " class="caption mt-2 font-weight-bold cyan--text tex-accent-2">
                                <v-avatar class="mr-5 elevation-4 ml-10" size="47">
